    ...
    return (
        ...
        >
            ...
            <div style={{ fontSize: "0.8rem", width: "100%" }}>
                ...
                {/* _______________________________________________________ replybox for comments that don't have replies*/}
                    ...
                    replies.map((reply: FeedbackEntryReply, i: number) => (
                        <div key={i} style={{ display: "flex", marginTop: "2rem" }}>
                            ...
                            <div style={{ fontSize: "0.8rem", width: "100%" }}>
                                ...
                                {/* _______________________________________________________ replybox for comments that already have replies*/}
